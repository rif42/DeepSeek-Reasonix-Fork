...
func cliCompletionRootSpec() cliCompletionSpec {
	...
	root.subcommands = []cliCompletionSpec{
		...
		completionSpec("memory", []cliCompletionFlag{help},
			completionSpec("review", []cliCompletionFlag{help}),
		),
		completionSpec("routines", []cliCompletionFlag{help},
			completionSpec("start", []cliCompletionFlag{help}),
			completionSpec("cron", []cliCompletionFlag{help},
				completionSpec("create", []cliCompletionFlag{help}),
				completionSpecWithAliases("list", []string{"ls"}, []cliCompletionFlag{help}),
				completionSpec("show", []cliCompletionFlag{help}),
				completionSpec("run", []cliCompletionFlag{help}),
				completionSpec("pause", []cliCompletionFlag{help}),
				completionSpec("resume", []cliCompletionFlag{help}),
				completionSpec("remove", []cliCompletionFlag{help}),
			),
			completionSpec("webhook", []cliCompletionFlag{help},
				completionSpec("subscribe", []cliCompletionFlag{help}),
				completionSpecWithAliases("list", []string{"ls"}, []cliCompletionFlag{help}),
